...
print(f"🔄 Conectando ao ZenHub para extração total do ecossistema RetinaScan...")
        ...
        for pipe in ws_data.get("pipelines", []):
            ...
            for issue in issues_list:
                ...
                total_issues_list.append({
                    ...
                    "story_points": issue["estimate"]["value"] if issue.get("estimate") else 0.0,
                    "sprints": [s["name"] for s in issue.get("sprints", {}).get("nodes", [])],
                    "labels": labels,
